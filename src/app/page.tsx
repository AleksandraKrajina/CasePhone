      ...
      <section>
        <MaxWidthWrapper className='py-24'>
           ...
           <div className='mx-auto max-w-6xl px-6 lg:px-8'>
             <div className='relative  flex flex-col items-center md:gride 
                grid-cols-3 gap-40'>
              <img src='/arrow.png' 
              ...
              />
               ...
               max-w-sm rounded-xl bg-gray-900/5 ring-inset
               ring-gray-900/10 lg:rounded-2xl '>
                 <img src="/horse.jpg" className='rounded-md object-cover
                 bg-white shadow-2xl ring-1 ring-gray-900/10 h-full w-full'></img>
               </div>
          ...
          <ul className='mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit'>
            ...
            <li className='w-fit'>
              <Check className='h-5 w-5 text-green-600 inline mr-1.5 '/>
              Scratch- and fingerprint resistiant coating
            </li>
            <li className='w-fit'>
              <Check className='h-5 w-5 text-green-600 inline mr-1.5 '/>
            ...
            <div className='flex justify-center'>
              ...
              })} href='/configure/upload'> Create your case now 
              <ArrowRight className='h-4 w-4 ml-1.5'/></Link>
